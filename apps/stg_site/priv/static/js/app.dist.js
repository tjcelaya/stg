...
var _depsPhoenixWebStaticJsPhoenixJs = require('../../../../../deps/phoenix/web/static/js/phoenix.js');

var socket = new _depsPhoenixWebStaticJsPhoenixJs.Socket('/_ws');

socket.connect();

var ch = socket.channel('time:lobby', {});

ch.on("new_msg", function (payload) {
  console.log('receive', payload);
});

ch.join().receive('ok', function (r) {
...
},{"../../../../../deps/phoenix/web/static/js/phoenix.js":2}],2:[function(require,module,exports){
